...
func (uu *UserUpdate) SetAga(i int) *UserUpdate {
	uu.mutation.ResetAga()
	uu.mutation.SetAga(i)
	return uu
}

// AddAga adds i to aga.
func (uu *UserUpdate) AddAga(i int) *UserUpdate {
	uu.mutation.AddAga(i)
	return uu
}
...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.Aga(); ok {
		if err := user.AgaValidator(v); err != nil {
			return &ValidationError{Name: "aga", err: fmt.Errorf("ent: validator failed for field \"aga\": %w", err)}
		}
	}
	return nil
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Aga(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldAga,
		})
	}
	if value, ok := uu.mutation.AddedAga(); ok {
...
// SetAga sets the aga field.
func (uuo *UserUpdateOne) SetAga(i int) *UserUpdateOne {
	uuo.mutation.ResetAga()
	uuo.mutation.SetAga(i)
	return uuo
}

// AddAga adds i to aga.
func (uuo *UserUpdateOne) AddAga(i int) *UserUpdateOne {
	uuo.mutation.AddAga(i)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Aga(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldAga,
	...
	if value, ok := uuo.mutation.AddedAga(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldAga,
