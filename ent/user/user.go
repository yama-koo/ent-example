...
const (
	...
	FieldID = "id"
	// FieldAga holds the string denoting the aga field in the database.
	FieldAga = "aga"
...
var (
	// AgaValidator is a validator for the "aga" field. It is called by the builders before save.
	AgaValidator func(int) error
