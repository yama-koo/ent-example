...
// SetAga sets the aga field.
func (m *UserMutation) SetAga(i int) {
	m.aga = &i
	m.addaga = nil
}

// Aga returns the aga value in the mutation.
func (m *UserMutation) Aga() (r int, exists bool) {
	v := m.aga
	if v == nil {
		return
	}
...
// OldAga returns the old aga value of the User.
// If the User object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *UserMutation) OldAga(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldAga is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldAga requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldAga: %w", err)
	}
	return oldValue.Aga, nil
}

// AddAga adds i to aga.
func (m *UserMutation) AddAga(i int) {
	if m.addaga != nil {
		*m.addaga += i
	} else {
		m.addaga = &i
...
// AddedAga returns the value that was added to the aga field in this mutation.
func (m *UserMutation) AddedAga() (r int, exists bool) {
	v := m.addaga
	if v == nil {
		return
	}
...
// ResetAga reset all changes of the "aga" field.
func (m *UserMutation) ResetAga() {
	m.aga = nil
	m.addaga = nil
}
...
func (m *UserMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.aga != nil {
		fields = append(fields, user.FieldAga)
	}
	if m.name != nil {
