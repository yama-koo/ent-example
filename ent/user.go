...
type User struct {
	...
	// Aga holds the value of the "aga" field.
	Aga int `json:"aga,omitempty"`
...
func (u *User) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullInt64); !ok {
		return fmt.Errorf("unexpected type %T for field aga", values[0])
	} else if value.Valid {
		u.Aga = int(value.Int64)
	}
...
func (u *User) String() string {
	...
	builder.WriteString(", aga=")
	builder.WriteString(fmt.Sprintf("%v", u.Aga))
