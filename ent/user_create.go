...
func (uc *UserCreate) SetAga(i int) *UserCreate {
	uc.mutation.SetAga(i)
	return uc
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.Aga(); !ok {
		return &ValidationError{Name: "aga", err: errors.New("ent: missing required field \"aga\"")}
	}
	if v, ok := uc.mutation.Aga(); ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Aga(); ok {
